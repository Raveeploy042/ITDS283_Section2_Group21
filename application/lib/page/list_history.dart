      ...
      'orders': [
        {
          ...
          'itemCount': 3,
          'products': ['ผู้แทนโครงสร้าง SCG... (2)', 'เหล็กเส้นกลม... (1)', 'อิฐมวล... (10)'],
          'total': 735.00,
        }
      ]
    },
        ...
        itemBuilder: (context, index) {
          ...
          return Column(
            ...
            children: [
              ...
              // รายการคำสั่งซื้อ
              ...dateGroup['orders'].map<Widget>((order) => Card(
                elevation: 2,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        ...order['products'].take(2).map<Widget>((p) => 
                          Text('• $p', style: TextStyle(color: Colors.grey[600]))),
